...
exports.includeFile = function (file, priority, exp) {
	priority = priority || 0;
	...
	try {
	    ...
	    (actionsObject.include || []).forEach(function (include) {
			...
			exports.includeFile(include, priority, false);
		});
...
var updateSync = function () {
	...
	includeDirectories.forEach(function (directory) {
		...
		fs.readdirSync(directory).forEach(function(file) {
			exports.includeFile(libpath.join(directory, file), priority, false);
		});
	});
