...
exports.setEmitLog = function (bool)  {
	emitLog = bool;
};

exports.setLogToConsole = function (bool) {
	logToConsole = bool;
}
...
function exportActions() {
	...
	var outputFile = libpath.join(rootDir, "actions.json");
	fs.writeFileSync(outputFile, prettyPrint.json(globalSettings));
	settingsVersion++;
